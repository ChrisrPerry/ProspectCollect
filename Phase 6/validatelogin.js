...
if (haveAlerted == false){
	...
	var queryString = "?username=" + username + "&password=" + password + "&value=login";

	ajaxRequest.open("GET", "checkUserandPass.php" + queryString, true);
...
if(haveAlerted == false){
	...
	var queryString = "?username=" + username1 + "&password=" + password1 +"&email=" + email + "&value=register";
